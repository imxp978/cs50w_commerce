    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('currentprice', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=20)),
                ('activation', models.BooleanField()),
                ('time', models.DateTimeField(default=datetime.datetime(2023, 11, 3, 3, 1, 17, 506747))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time', models.DateTimeField(default=datetime.datetime(2023, 11, 3, 3, 1, 17, 507177))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time', models.DateTimeField(default=datetime.datetime(2023, 11, 3, 3, 1, 17, 507478))),
        ...
        migrations.AddField(
            model_name='user',
            name='watchlist',
            field=models.ManyToManyField(related_name='watchlistuser', to='auctions.listing'),
        ),
    ]
